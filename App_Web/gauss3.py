...
def error_test(y, z=1):
    if z == 1:
        while error_test2(y):
            print ("Se han ingresado valores o caracteres no validos.")
            y = raw_input("Por favor, reingrese el valor deseado: ")
        return int(y)
    elif z == 2:
        while error_test3(y):
            print ("Se han ingresado valores o caracteres no validos.")
...
dimy = error_test(input("Ingrese la cantidad de filas de la matriz: "), 1)
dimx = error_test(input("Ingrese la cantidad de columnas de la matriz: "), 1)
